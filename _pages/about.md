...
I am an MSc candidate in **Computational Science &amp; Engineering** at **ETH Zürich**, currently completing my master's thesis at **MIT's DeCoDe Lab** on mixed-variable Bayesian optimisation for engineering design. I came to machine learning through mechanical engineering and multi-physics simulation, and that route still shapes how I work.
...
This site collects my work across **software &amp; ML**, **simulation &amp; modelling**, **mechanical &amp; hardware**, and **team leadership**. Use the [projects](/work/) page to filter by area, or see my [CV](/cv/).
